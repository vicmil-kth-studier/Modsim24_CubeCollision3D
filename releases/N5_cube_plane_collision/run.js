...
var ASM_CONSTS = {
 ...
 193681: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 193764: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 193833: () => { return window.innerWidth; },  
 193863: () => { return window.innerHeight; }
};
